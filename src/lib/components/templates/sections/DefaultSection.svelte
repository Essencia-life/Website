...
<script lang="ts">
	...
	import CardGridWidget, { cardGridWidgetField } from '../widgets/CardGridWidget.svelte';
	import GalleryGridWidget, { galleryGridWidgetField } from '../widgets/GalleryGridWidget.svelte';
	import YouTubeVideoWidget, { youtubeVideoWidgetField } from '../widgets/YouTubeVideoWidget.svelte';
	import StepsWidget, { stepsWidgetField } from '../widgets/StepsWidget.svelte';
	import TallyFormWidget, { tallyFormWidgetField } from '../widgets/TallyFormWidget.svelte';
	import ColumnsWidget, { columnsWidgetField } from '../widgets/ColumnsWidget.svelte';
...
<section id={section.id} class="py-16" class:text-center={section.textCenter} class:secondary={section.bgSecondary} class:dark={section.bgDark}>
	<div class="page-content">
        <svelte:element this={index === 0 ? 'h2' : 'h3'} class="mb-6">
            {#if section.supline}
	    	    <sup class="block top-0 mb-2">{section.supline}</sup>
            {/if}
            {section.headline}
        </svelte:element>
